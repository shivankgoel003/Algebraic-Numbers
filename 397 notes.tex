...
\thm{}{Let $\xi$ be an algebraic number of degree $n$ and height $A$. Then, the degree of the field $Q(\xi)$ over $Q$ is at most $n$. Then
any element of $Q(\xi)$ can be uniquely written as 
$a_0 + a_1 \xi + a_2 \xi^2 + \dots + a_{n-1} \xi^{n-1}$ where $a_0, a_1, \dots, a_{n-1} \in Q$.}
